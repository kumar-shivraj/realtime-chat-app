    ...
    <div className={`bg-[#818582]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? 'max-md:hidden' : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            <img src={assets.menuIcon} alt=' Menu' className='max-h-5 cursor-pointer' />
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
          <img src={assets.searchIcon} alt='Search' className='w-3 h-3' />
          <input
            type='text'
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index) => (
          ...
          >
            <img
              src={user?.profilePic || assets.avatarIcon} alt=''
